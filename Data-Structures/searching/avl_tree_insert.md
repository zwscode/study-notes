During inserting, 4 conditions will break the property of AVL tree.
1. left-left：Rotate Right
2. right-right: Rotate Left
3. left-right：Rotate Left, then Rotate Right
4. right-left：Rotate Right, then Rotate Left
